...
<form method="get" action="index.do"> <!-- 검색한 결과에 대한 url이 나와야 친구에게 주소를 링크로 공유할 수 있다. -->
...
<input type="button" value="등록" onclick="location.href='write.do';"><!-- 상대경로! 현재 페이지 board/index.do로 접속한 상태에서 write.do로 이동 -->
</body>
</html>